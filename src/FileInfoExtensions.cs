...
public static class FileInfoExtensions
{
    extension(FileInfo fileInfo)
    {
        ...
        public FileInfo CopyTo(DirectoryInfo target, bool overwrite = false) => fileInfo.CopyTo(Path.Combine(target.FullName, fileInfo.Name), overwrite);
        ...
        public bool CompareHash(FileInfo other) => fileInfo.ComputeMD5Hash() == other.ComputeMD5Hash();
    }
